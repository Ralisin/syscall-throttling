...
bool st_state_matches(__u32 syscall_number, const struct path *executable, __u32 effective_uid);
bool st_state_get_admission(__u32 syscall_number, const struct path *executable, __u32 effective_uid, __u32 *max_per_second);
